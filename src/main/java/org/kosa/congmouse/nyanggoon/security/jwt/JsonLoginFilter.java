...
import org.kosa.congmouse.nyanggoon.dto.LoginRequestDto;
...
public class JsonLoginFilter extends UsernamePasswordAuthenticationFilter {
     ...
     * JSON 본문에서 로그인 정보 추출
     *
     * @param request  HTTP 요청 (email, password 포함)
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        log.info("인증 성공: email={}, role={}", member.getEmail(), role);
...
// ApiResponseDto.success()를 사용하여 표준 응답 생성
        ...
        log.info("JWT 토큰 발급 완료: email={}", member.getEmail());
    }
